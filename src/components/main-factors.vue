<template>
        <div>
              <div class="column is-desktop is-full-mobile"  >
                  <div class="hello" >Основные{{who}}</div>

                <section class="panel">
                  <p class="panel-heading">
                    <button class="button is-primary" v-on:click="func1">Commodity turnover</button>
                  </p>
                  <p class="panel-tabs">
              ...
              <div class="column is-desktop is-full-mobile">
                <section class="panel">
                  <p class="panel-heading">
                    <button class="button is-primary" v-on:click="func2">Sales</button>
                  </p>
                  <div class="panel-block">
              ...
              <div class="column is-desktop is-full-mobile">
                <section class="panel">
                  <p class="panel-heading">
                    ...
                    <button class="button is-primary" v-on:click="func3">YoY Comparison</button>
                  </p>
                  <div class="panel-block">
                ...
                <section class="panel">
                 ...
                 <div class="panel-block">
                  <div class="notification is-warning">
                    ...
                    <strong>Purchase order for cocoa powder.</strong>
                    <p>
                  ...
                  <div class="notification">
                    <button class="delete" onclick="((this).parentNode.remove())"></button>
                    <strong>Shipment of cocoa powder.</strong>
                    <p>
                  ...
                  <div class="notification">
                    <button class="delete" onclick="((this).parentNode.remove())"></button>
                    <strong>Bank - the arrival of payment under the contract.</strong>
                   <p>
